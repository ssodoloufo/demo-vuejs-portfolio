		...
		<div class="z-10 max-w-screen-lg xl:max-w-screen-xl block sm:flex sm:justify-between sm:items-center my-6">
			...
			<div class="flex justify-between items-center px-4 sm:px-0">
				...
				<div>
					<router-link to="/">
						...
						<img src="@/assets/images/logo.png" class="w-8" title="SSODOLOUFO" alt="Light Logo" />
						<!-- <span class="font-general-medium leading-none text-lg">SSODOLOUFO</span> -->
					</router-link>
				</div>

				<!-- Theme switcher small screen -->
				<theme-switcher :theme="theme" @themeChanged="updateTheme" class="block sm:hidden bg-ternary-light dark:bg-ternary-dark hover:bg-hover-light dark:hover:bg-hover-dark hover:shadow-sm px-2.5 py-2 rounded-lg" />
			...
			<div class="hidden sm:flex justify-between items-center flex-col md:flex-row">
				...
				<!-- <div class="hidden md:block">
					<Button @click="showModal()" title="Hire Me" aria-label="Hire Me Button" class="text-md font-general-medium bg-yellow-500 hover:bg-yellow-600 text-white shadow-sm rounded-md px-5 py-2.5 duration-300" />
				</div> -->

				<!-- Theme switcher large screen -->
				<theme-switcher :theme="theme" @themeChanged="updateTheme" class="ml-8 bg-primary-light dark:bg-ternary-dark px-3 py-2 shadow-sm rounded-xl cursor-pointer" />
			</div>
		</div>
