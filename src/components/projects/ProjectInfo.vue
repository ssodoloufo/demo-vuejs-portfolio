...
<template>
	<div class="block sm:flex gap-0 sm:gap-10 mt-14">
		...
		<div
			class="w-full sm:w-1/3 text-left leading-loose max-w-xl m-1 p-7 bg-primary-light dark:bg-secondary-dark rounded-xl shadow-xl text-left"
		>
			...
			<div>
				...
				<div class="flex items-center gap-3 mt-5">
					<a
						...
						class="bg-ternary-dark dark:bg-ternary-light text-gray-400 hover:text-primary-light dark:hover:text-primary-dark p-2 rounded-lg shadow-sm duration-500"
						><i
